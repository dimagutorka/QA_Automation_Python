...
def select_conversion_type():
    ...
    while True:
        ...
        try:
            selection = input("Enter selection C or F (q - to exit): ")
        except Exception:
            continue
